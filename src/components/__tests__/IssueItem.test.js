...
describe("IssueItem", () => {
  ...
  it("should contain the expected text", () => {
    act(() => {
      ...
      // - HINT: Provide an `issue` prop and use the `issue` object in this test as the value.
  ...
  //
  // HINT: How can the snapshot test in SearchBar be used as a reference for writing this test?
